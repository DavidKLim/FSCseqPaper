...
[here](https://github.com/DavidKLim/FSCseqPaper/tree/master/SimulateData).
Then, all simulation analyses done in the FSCseq paper can be replicated
by following the steps
[here](https://github.com/DavidKLim/FSCseqPaper/tree/master/Simulations).
...
following the steps
[here](https://github.com/DavidKLim/FSCseqPaper/tree/master/RealData).
All analyses were run as batch jobs in slurm.
